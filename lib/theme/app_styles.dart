...
class AppStyles {
  ...
  static TextStyle get titleLarge => const TextStyle(
    ...
    shadows: [
      ...
      Shadow(color: AppColors.glowGold, blurRadius: 10),
    ],
  );
  ...
  static TextStyle get titleMedium => const TextStyle(
    ...
    fontSize: 20,
    fontWeight: FontWeight.bold,
    shadows: [Shadow(color: AppColors.glowGold, blurRadius: 15)],
  );
  ...
  static BoxDecoration get buttonDecoration => BoxDecoration(
    ...
    boxShadow: const [
      BoxShadow(color: AppColors.glowGold, blurRadius: 15, spreadRadius: 2),
      BoxShadow(
